...
namespace StringCalculator.Tests
{
    public class StringCalculatorTests
    {
        ...
        [Fact]
        public void IfStringContainsNegativeNumbers_ReturnListOfNegativeNumbers()
        {

            int result = StringCalculator.Add("//;\n-1\n3,-5;5");
            result.Should().BeOfType<Exception>.WithMessage("*change the unit of an existing ingredient*");
        }
